---
title: Form layout
description: Use SCSSLeon form and form layout components to build things like settings screens in your application. These form components are designed and built by the SCSSLeon team, and include a variety of different styles and layouts.
categories:
- forms
image :
  url : './form_layout.jpg'
...
<Snippet title={'Form layout 1'} preview={true}>
  <Fragment slot="html">
    <Raw file={file} line_start={19} line_end={58}>
      ```
      <div class="form">
        <div class="grid">
          <div class="section">
  ...
  <Fragment slot="scss">
    <Raw file={file} line_start={65} line_end={146}>
      ```
      @use "sass:list";
      @use "sass:string";
      @use "sass:meta";
