...
<Snippet title={'Pagination 1'} preview={true} file={file}>
    <Fragment slot={'html'}>
        ```html
...
<Snippet title={'Pagination 2'} preview={true} file={file}>
    <Fragment slot={'html'}>
        ```html
        <nav class="pagination" aria-label="Pagination"
...
<Snippet title={'Pagination 3'} preview={true} file={file}>
    <Fragment slot={'html'}>
        ```html
...
<Snippet title={'Pagination 4'} preview={true} file={file}>
    <Fragment slot={'html'}>
        ```html
