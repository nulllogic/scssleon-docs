...
<Snippet file={file} title={'Pagination 1'} preview={true}>
    <Fragment slot={'html'}>
        ```
...
<Snippet file={file} title={'Pagination 2'} preview={true}>
    <Fragment slot={'html'}>
        ```
        <nav class="pagination" aria-label="Pagination"
...
<Snippet file={file} title={'Pagination 3'} preview={true}>
    <Fragment slot={'html'}>
        ```
...
<Snippet file={file} title={'Pagination 4'} preview={true}>
    <Fragment slot={'html'}>
        ```
