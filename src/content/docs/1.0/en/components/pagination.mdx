...
<Snippet frame_url={'components/pagination/1'} preview={true}>
    <Fragment slot={'html'}>
        ```html
...
<Snippet frame_url={'components/pagination/2'} preview={true}>
    <Fragment slot={'html'}>
        ```html
        <nav class="pagination" aria-label="Pagination"
...
<Snippet frame_url={'components/pagination/3'} preview={true}>
    <Fragment slot={'html'}>
...
<Snippet frame_url={'components/pagination/4'} preview={true}>
    <Fragment slot={'html'}>
