...
<Snippet title={'Placeholder 1'} preview={true} file={file}>
    <Fragment slot="html">
        ```html
...
<Snippet title={'Placeholder 2'} preview={true} file={file}>
    <Fragment slot="html">
        ```html
        <div class="placeholder" aria-hidden="true">
            <span class="el"></span>
...
<Snippet title={'Placeholder 3'} preview={true} file={file}>
    <Fragment slot="html">
        ```html
...
<Snippet title={'Placeholder 4'} preview={true} file={file}>
    <Fragment slot="html">
        ```html
