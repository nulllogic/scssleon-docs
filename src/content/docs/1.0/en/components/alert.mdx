...
<Snippet preview={true}>
    <Fragment slot="html">
      <Raw file={file} line_start={14} line_end={35}>
    ...
    <Fragment slot="scss">
      <Raw file={file} line_start={40} line_end={65}>
        @use "sass:list";
        @use "sass:string";
        @use "sass:meta";
        @use "sass:map";
...
<Snippet preview={true}>
    <Fragment slot="html">
      <Raw file={file} line_start={73} line_end={89}>
        <div class="alert" role="alert">
            <div class="center">
    ...
    <Fragment slot="scss">
      <Raw file={file} line_start={94} line_end={111}>
        @use "sass:list";
        @use "sass:string";
        @use "sass:meta";
        @use "sass:map";
