...
<Snippet title={'Input 1'} preview={true} file={file}>
  <Fragment slot="html">
    ```html
    <div class="form">
      <div class="field">
...
<Snippet title={'Input 2'} preview={true} file={file}>
  <Fragment slot="html">
      ```html
      <div class="form">
        <div class="field">
...
<Snippet title={'Input 3'} preview={true} file={file}>
  <Fragment slot="html">
      ```html
      <div class="form">
        <div class="field">
...
<Snippet title={'Input 4'} preview={true} file={file}>
  <Fragment slot="html">
    ```html
      <div class="form">
        <div class="field">
...
<Snippet title={'Input 5'} preview={true} file={file}>
  <Fragment slot="html">
      ```html
      <div class="form">
        <div class="field">
...
<Snippet title={'Input 6'} preview={true} file={file}>
  <Fragment slot="html">
      ```html
