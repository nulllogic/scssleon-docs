...
<Snippet file={file} title={'Input 1'} preview={true}>
  <Fragment slot="html">
    ```
    <div class="form">
      <div class="field">
...
<Snippet file={file} title={'Input 2'} preview={true}>
  <Fragment slot="html">
      ```
      <div class="form">
        <div class="field">
...
<Snippet file={file} title={'Input 3'} preview={true}>
  <Fragment slot="html">
      ```
      <div class="form">
        <div class="field">
...
<Snippet file={file} title={'Input 4'} preview={true}>
  <Fragment slot="html">
    ```
      <div class="form">
        <div class="field">
...
<Snippet file={file} title={'Input 5'} preview={true}>
  <Fragment slot="html">
      ```
      <div class="form">
        <div class="field">
...
<Snippet file={file} title={'Input 6'} preview={true}>
  <Fragment slot="html">
      ```
